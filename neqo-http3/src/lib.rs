    ...
    pub const fn connection_error(&self) -> bool {
        matches!(
            ...
            Self::HttpGeneralProtocol
                ...
                | Self::Qpack(Qpack::EncoderStream | Qpack::DecoderStream)
        )
    }
...
impl From<Qpack> for Error {
    fn from(err: Qpack) -> Self {
        match err {
            Qpack::ClosedCriticalStream => Self::HttpClosedCriticalStream,
            e => Self::Qpack(e),
        }
    }
}
...
impl From<AppError> for Error {
    fn from(error: AppError) -> Self {
        match error {
            ...
            0x200 => Self::Qpack(Qpack::DecompressionFailed),
            0x201 => Self::Qpack(Qpack::EncoderStream),
            0x202 => Self::Qpack(Qpack::DecoderStream),
