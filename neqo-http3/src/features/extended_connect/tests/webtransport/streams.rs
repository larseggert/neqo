...
fn wt_client_stream_uni_reset() {
    ...
    wt.receive_reset_server(wt_stream, Error::HttpNo.code());
}
...
fn wt_client_stream_bidi_reset() {
    ...
    wt.receive_reset_server(wt_server_stream.stream_id(), Error::HttpNo.code());
...
fn wt_server_stream_uni_stop_sending() {
    ...
    wt.receive_stop_sending_server(wt_server_stream.stream_id(), Error::HttpNo.code());
}
